    ...
    public class EventBusRabbitMQ : IEventBus, IDisposable
    {
        ...
        private IModel CreateConsumerChannel()
        {
            ...
            try
            {
                ...
                string strDLXQ = "DLX_Q_" + _queueName, strDLXEX = "DLX_EX_" + _queueName;
                channel.ExchangeDeclare(strDLXEX, ExchangeType.Fanout);
                channel.QueueDeclare(strDLXQ, true, false, false, null);
                channel.QueueBind(strDLXQ, strDLXEX, "");

                var arguments = new Dictionary<string, object>()
                {
                    {"x-dead-letter-exchange", strDLXEX},
